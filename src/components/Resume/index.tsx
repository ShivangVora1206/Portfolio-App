...
export default function Resume(params:any) {
    ...
    return (
        <div className={`h-full w-full flex flex-col justify-center items-center dark:bg-resume-bg-dark bg-resume-bg bg-cover bg-no-repeat bg-center duration-150`}>
            ...
            {buttonClicked ? <object data={window.location.origin + "/" + resumeLink} type="application/pdf" className="w-custom-large-pdf-width h-custom-large-pdf-height mb-10 duration-200"/> : <div/>}
